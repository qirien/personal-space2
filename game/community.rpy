...
label community26:
    ...
    label after_firegrass_26:
        ...
        ilian normal "I'm going to to a demonstration for you here which shows you how the meat is grown."
        ...
        ilian "We sprinkle a little xanthan gum on top to prevent fungal growth."
        ...
        thuc "Hmm, the texture is good. It doesn't have a strong taste."
        ...
        if (mavericks_strong()): #8 #maxiumum is 18
            ...
            pete normal "Hmm. That's not what I heard. I heard that someone is selling firegrass for cheaper than I am. So now everyone gets it from him instead of me."
            if stop_buying_beef:
...
label no_euthanasia:
    ...
    "He had a stroke that left him unable to speak coherently."
    scene farm_interior with fade
    show him concerned at midleft
    ...
    label funeral:
        ...
        julia "He even tried my recipe for goat jerky when a bunch of our goats died and we had to preserve the meat quickly."
        julia "It was one of the most disgusting things I've ever eaten... and Pavel agreed with me! But he didn't chide me for wasting spices."
        julia "He just said that that was the price of admission for culinary creativity."
        hide julia with moveoutright
        sara "There was a community meeting where a farmer came in and told Pavel all the things he was doing wrong as mayor."
        sara normal "She was getting very specific, and some of her complaints were a bit personal, saying that Pavel was more interested in cooking than the real problems at hand."
...
label community29:
    ...
    label helen_convo_29:
        ...
        helen sad "I really miss my family though, and certain foods we like to make."
        ...
        helen happy "I like to make a soup with the feet and tail and some of the innards. We even ate the brains a few times! It's not very healthy but it was something different."
        ...
        him content "Just try to stay healthy and grow that baby. Do you know what you want to name her?"
        ...
        pete angry "What is going on? It still says insufficient funds."
        pete normal "[his_name], can you try drawing a credit from my account to verify that it's not just something on [her_name]'s tablet?"
        him pout "Okay, here."
        pete normal "Still the same problem. I know I had over a thousand in there last week."
        pete angry "Someone stole from me. But I guess that's my problem."
        helen sad "Here, take Sage's things and sell them to the storehouse. That should pay for some of it."
...
label community30:
    ...
    if kevin_elected:
        ...
        #TODO check if display is still flashing to chat
...
#            kid shifty "Happy to help."
            ...
            oleg happy "I'm grown up now. You can go back if you want to."
            ...
            oleg normal "Nevermind, I thought it looked like one of the videogame controllers we printed."
...
#        if (mavericks_strong("moderate")): #8 #check values #only if you don't talk to Oleg?
...
#                pete "{i}I give her a discount because she buys in bulk and does more of the processing.{/i}" #bundling up the firegrass in amounts measured by the little plastic ring
...
#                him "I found firegrass hidden in one of Noel's rain barrels."
                    ...
                    label neglect:
                        ...
                        if kevin_elected:
                            ...
                            label accuse_noel_neglect:
                                ...
                                him concerned "I think we both did our jobs."
                                thuc sad "I hope we can put this incident behind us soon."
                                "After thirty minutes the jury was still going."
    ...
    #                                            "I testified about how I had found hidden firegrass at Noel's house."
                                            ...
                                            if ban_firegrass:
                                                ...
                                                if talked_to_pete or know_noel_had_firegrass: #is talked_to_pete deprecated?
