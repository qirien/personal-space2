init -1:
    ...
    image ocean = "bg/ocean.jpg"
    image storehouse = "bg/storehouse.jpg"
    image community_center = "bg/community-center.jpg"
    image lab = "bg/lab.jpg"
    image barn = "bg/barn.jpg"
    image mountains = "bg/mountains.jpg"
    image stream = "bg/stream.jpg"
    image hotspring = "bg/hot-spring.jpg"
    image tractor = "bg/tractor.jpg"
    image church = "bg/church.jpg" 
    image city_street = "bg/city-street.jpg"
    image bathhouse = "bg/bathhouse.jpg"
    image gray_silk = "bg/silk-gray.jpg"
