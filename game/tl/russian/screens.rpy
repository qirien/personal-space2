...
translate russian strings:
    ...
    old "Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only]. Ren'Py License:\n\n[renpy.license!t]"
    new ""
    ...
    old "Automatically place crops on the farming screen."
    new ""

    # game/screens.rpy:1165
    old "Close sub screens."
    new ""
