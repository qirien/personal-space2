...
init -100:
    ...
    python:
        ...
        if (not persistent.achievements):
            ...
            # Game Progression
                "Carbon Copy": {"desc":"Trained Daughter in Farming", "file":"ach00.jpg"},
                "Binary System": {"desc":"Father of Two", "file":"ach01.jpg"},
                "Patience Grandmaster": {"desc":"Kept your Cool", "file":"ach02.jpg"},
                "Talked the Talk": {"desc":"Answered Her Biology Questions", "file":"ach03.jpg"},
                "Over the Hill": {"desc":"Turned 40", "file":"ach04.jpg"},
            # Special weird things
                "Scurvy Dog": {"desc":"Got Scurvy", "file":"ach05.jpg"}, 
                "Rich Dad": {"desc":"Saved a LOT of credits!", "file":"ach06.jpg"}, 
                "Poor Dad": {"desc":"Deep in debt", "file":"ach07.jpg"}, 
                "Blackberry & Asparagus": {"desc":"Good Marriage Relationship", "file":"ach08.jpg"}, 
                "Potato Papa": {"desc":"Planted almost all Potatoes", "file":"ach09.jpg"}, 
                "Mutant Ninja Berries": {"desc":"Had Mutated Strawberries", "file":"ach10.jpg"}, 
                "Chez Dad": {"desc":"Ate Alien Escargot", "file":"ach11.jpg"}, 
                "Family Beeswax": {"desc":"Got Bees", "file":"ach12.jpg"}, 
            ...
            # Achievements for each parenting style
                ...
                "Who Needs Rules?": {"desc":"Permissive Parent", "file":"ach21.jpg"},
                "Hands-Off Approach": {"desc":"Neglectful Parent", "file":"ach22.jpg"},
            # Achievements for each community favored
                "Xenophiliac": {"desc":"Friend to the Jellies", "file":"ach23.jpg"},
                "Don't Tread on Me": {"desc":"Friend to the Mavericks", "file":"ach24.jpg"},
                "It Takes This Village": {"desc":"Friend to the Colonists", "file":"ach25.jpg"},
                "Miner Details": {"desc":"Friend to the Miners", "file":"ach26.jpg"},            
            }
